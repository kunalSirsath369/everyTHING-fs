  ...
  <div class="flex flex-col items-center   w-full mx-auto ">
      ...
      <div class="w-full bg-black rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p className="text-white ">Sign up for early Sale access plus tailored new arrivals, trends and promotions. To opt out, click unsubscribe in our emails.</p>
              <a href="/register" >
              <button type="submit" class="border mt-5 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Register</button></a>
          </div>
      </div>
  </div>
</section>
